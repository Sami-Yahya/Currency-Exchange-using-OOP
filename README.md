...
This project is part of our continuous OOP journey with **_“Course 11 - OOP as it Should Be (Applications)”_** with **Dr. Mohammed Abu-Hadhoud** at [ProgrammingAdvices.com](https://www.programmingadvices.com).  
...
- ❌ If not found → shows an error message, and ask again.
...
## 🧩 Comparison: Previous Project vs This Project

| Aspect | Previous Project – Bank System | This Project 13 – Bank System & Currency Exchange |
|--------|--------------------------|----------------------------------------------|
...
## 💻 GitHub Repository  
🔗 [github.com/Sami-Yahya/Currency-Exchange-using-OOP](https://github.com/Sami-Yahya/Currency-Exchange-using-OOP)
